...
const getAudioPath = (filename: string) => {
  // Check if we're on Netlify (netlify.app domain) or local development/Replit
...
const musicItems = [
  {
    ...
    audioSrc: getAudioPath("jana-gana-mana.mp3"),
  ...
  },
  {
    ...
    audioSrc: getAudioPath("vande.mp3"),
  },
  {
    ...
    audioSrc: getAudioPath("sare.mp3"),
  },
  {
    ...
    audioSrc: getAudioPath("watan.mp3"),
  },
  {
    title: "India Wale",
    ...
    audioSrc: getAudioPath("indiawale.mp3"),
  },
];
