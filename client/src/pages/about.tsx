          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-b from-orange-100 via-white to-green-100 rounded-lg p-8 shadow-lg border-2 border-flag-green relative">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-gray-800">
                <p>
                  Namaste! Mera naam <strong>Himanshu</strong> hai aur main is
                  samay <strong>S. A. M Inter College, Saharanpur</strong> mein{" "}
                  <strong>11vi kaksha mein vigyan varg ka chhatra hoon</strong>.
                  Main <strong>Uttar Pradesh ke Saharanpur zila</strong> se
                  hoon.
                </p>

                <p>
                  Mujhe technology, khaaskar{" "}
                  <strong>coding aur web development</strong> mein gahri ruchi
                  hai. Main ek <strong>full stack developer</strong> banne ki
                  disha mein kaam kar raha hoon aur lagataar nai cheezein
                  seekhkar apne <strong>skills</strong> ko behtar bana raha
                  hoon. Mujhe <strong>website design karna</strong> aur{" "}
                  <strong>user-friendly interface banana</strong> bahut pasand
                  hai.
                </p>

                <p>
                  <strong>Coding karna</strong> na sirf mera shauk hai, balki
                  main ise apne <strong>career ke roop mein</strong> bhi aage
                  badhana chahta hoon. Main hamesha kuch naya seekhne aur
                  takneek ki duniya mein khud ko aage badhane ke liye tayar
                  rehta hoon.
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-b from-orange-100 via-white to-green-100 rounded-lg p-8 shadow-lg border-2 border-flag-green relative">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-gray-800">
                <p>
                  Namaste! Mera naam <strong>Lavish</strong> hai aur main is
                  samay <strong>S. A. M Inter College, Saharanpur</strong> mein{" "}
                  <strong>11vi kaksha mein vigyan varg ka chhatra hoon</strong>.
                  Main <strong>Uttar Pradesh ke Saharanpur zila</strong> se
                  hoon.
                ...
                <p>
                  Mujhe technology, khaaskar{" "}
                  <strong>coding aur web development</strong> mein gahri ruchi
                  hai. Main ek <strong>frontend developer</strong> banne ki
                  disha mein kaam kar raha hoon aur lagataar nai cheezein
                  seekhkar apne <strong>skills</strong> ko behtar bana raha
                  hoon. Mujhe <strong>website design karna</strong> aur{" "}
                  <strong>user-friendly interface banana</strong> bahut pasand
